...
import productos from '../data/PreciosW.json'
...
const Snaks = () => {
 ...
 <h2 id='subtitulos' className="text-[#FFB800] mt-24 mb-5 font-semibold text-6xl text-center max-sm:text-center drop-shadow-[0_1px_5px_rgba(0,0,0,0.8)]">Crujientes</h2>
